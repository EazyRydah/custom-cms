...
class Article 
{
     ...
     *
     * @return mixed An objectof this class, or null of not found
     */
    public static function getByID($conn, $id, $columns="*") 
    {
        ...
        $stmt->setFetchMode(PDO::FETCH_CLASS, "Article"); // Fetch object instead of array

        if ($stmt->execute()) {
            
            return $stmt->fetch(); // return object of class article
        }
    }
    ...
    /**
     * Validate the properies, putting any validation error messages in the $errors property
     *
    ...
    /**
     * Publish the article, setting the published_at field to the curernt date and time
     *
     * @param object $conn Connection to the database
     *
